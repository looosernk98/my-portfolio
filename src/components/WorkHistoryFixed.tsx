...
import { 
  Building, Calendar, MapPin, TrendingUp, Users, Code, Lightbulb, 
  Award, Target, Zap, Star, ExternalLink, ChevronDown, ChevronUp,
  Briefcase, Clock, Globe, Rocket, Trophy, GitBranch, Heart
} from 'lucide-react'
...
const workExperience = [
  ...
  },
  {
    ...
    metrics: [
      ...
      { label: "Speed Boost", value: "+50%", icon: Zap, color: "from-yellow-500 to-orange-500" },
